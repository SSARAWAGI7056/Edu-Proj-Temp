...
import { Award, Users, BookOpen, Target, Play } from 'lucide-react';
...
export const AboutUsPage: React.FC = () => {
  ...
  return (
    <div className="relative w-full">
      ...
      <section className="min-h-screen w-full flex flex-col items-center justify-center bg-gray-50 px-6 md:px-8 lg:px-12">
        <div className="w-full flex flex-col items-center gap-6">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-center text-gray-900 leading-tight min-h-[2.5rem]">
            {typedText}
      ...
      <section className="min-h-screen w-full bg-white flex items-center px-6 md:px-8 lg:px-12">
        <div className="w-full flex flex-col md:flex-row gap-10 items-start">
          ...
          <div className="flex-1">
            <div className="h-full w-full bg-gray-900 text-white rounded-2xl p-10 shadow-md">
